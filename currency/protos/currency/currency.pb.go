...
type StreamingRateResponse_RateResponse struct {
	RateResponse *RateResponse `protobuf:"bytes,1,opt,name=rate_response,json=rateResponse,oneof"`
}
...
func _StreamingRateResponse_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *StreamingRateResponse_RateResponse:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RateResponse); err != nil {
			return err
		}
...
func _StreamingRateResponse_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*StreamingRateResponse)
	switch tag {
	case 1: // message.rate_response
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RateResponse)
		err := b.DecodeMessage(msg)
		m.Message = &StreamingRateResponse_RateResponse{msg}
		return true, err
...
var fileDescriptor0 = []byte{
	...
	,
}
